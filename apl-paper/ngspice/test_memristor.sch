...
C {devices/code_shown.sym} -20 100 0 0 {name=s1 only_toplevel=false value=".include ./memristor_non-pinched.spice
.tran 0.0933 56 28
.save all"}
...
C {memristor_non-pinched.sym} 80 10 0 0 {name=X1
